...
public class HttpProtocol {
    ...
    public static void main(String[] args) {
       ...
       result= (statusCode==200)?"OK":(statusCode==201)?"Created":(statusCode==202)?"Accepted"
               ...
               :(statusCode==307)?"Temporary Redirect":(statusCode==400)?"Bad Request":(statusCode==401)?"Unauthorised"
               :(statusCode==403)?"Forbidden":(statusCode==404)?"Not Found" :(statusCode==410)?"Gone"
               :(statusCode==500)?"Internet Server Error":(statusCode==503)?"Unavailable":"Wrong Entry";
