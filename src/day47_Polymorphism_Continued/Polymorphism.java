...
import day38_Inheritance.CarTask.CarTask.BMW;
import day38_Inheritance.CarTask.CarTask.Car;
import day38_Inheritance.CarTask.CarTask.Tesla;
import day38_Inheritance.CarTask.CarTask.Toyota;

public class Polymorphism {
    // method overriding=  having one method with multiple implementation, only the instance methods can be overridden,
    // static methods can not be overridden

    // method overloading= any method can be overloaded, creating a different with different parameters and names
