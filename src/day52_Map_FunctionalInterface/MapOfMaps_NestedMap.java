...
public class MapOfMaps_NestedMap {
    ...
    public static void main(String[] args) {
       ...
       mapOfMaps.put(map1,map2);
        ...
        Map< Map<Map<Integer, Integer>, Map<Integer, Integer>>,  Map<Map<Integer,
                Integer>, Map<Integer, Integer>> > mapOfMapOfMap = new LinkedHashMap<>();
